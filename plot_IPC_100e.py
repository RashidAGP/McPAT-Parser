...
data = np.genfromtxt('IPC_100e.csv',delimiter=',',skip_header=0,usecols=(0,1,2))
...
ax.axhline(y=110, color='grey', linestyle='--',alpha=0.5)
ax.axhline(y=120, color='grey', linestyle='--',alpha=0.5)
...
plt.tight_layout()
plt.savefig('IPC_100e.pdf',format='pdf', dpi=300)
#plt.show()
