...
folder_path_vanilla = '/home/rashid/rashid_rackham/results/1cores/RXT_v23/'
...
csv_file_path = './Pointer_Chasing.csv'
        ...
        with open(txt_file_path_vanilla, 'r') as file_vanilla:
            ...
            for line_vanilla in file_vanilla:
                ...
                if match_vanilla_access:
                    ...
                    result.append((directory_name, (number_finish / number_vanilla_access)*100 ))
                    numbers_gmean_vanilla.append(float(number_finish / number_vanilla_access)* 100)
                    print(str(result))
                    break
