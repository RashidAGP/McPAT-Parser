...
data = np.genfromtxt('L2_MPKI.csv',delimiter=',',skip_header=0,usecols=(0,1))
...
plt.tight_layout()
plt.savefig('fig_MPKI_L1.pdf',format='pdf',bbox_inches='tight', dpi=300)
#plt.show()
