...
directory_names = ["bc" ,"bfs", "cc", "cc_sv", "sssp" ,"pr","pr_spmv", "tc", "crono_apsp", "crono_bc", "crono_cc", "crono_pagerank", "crono_sssp", "crono_tc", "crono_tsp", "crono_XSBench", "crono_XSBench_hash" , "crono_XSBench_nuclide", "crono_gups"]
csv_file_path = './L2_TLB_MPKI.csv'
        ...
        with open(txt_file_path_vanilla, 'r') as file_vanilla:
            ...
            for line_vanilla in file_vanilla:
                ...
                if match_vanilla:
                    ...
                    result.append((directory_name, number_vanilla / 480000 ))
                    numbers_gmean_vanilla.append(float(number_vanilla / 480000))
                    print(str(result))
                    break
