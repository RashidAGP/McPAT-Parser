...
folder_path_vanilla = '/home/rashid/rackham_results/1cores/PREFETCH_v23/'
...
for directory_name in directory_names:
    dir_path_vanilla = os.path.join(folder_path_vanilla, directory_name + str("_raw") )
        ...
        with open(txt_file_path_vanilla, 'r') as file_vanilla:
            ...
            for line_vanilla in file_vanilla:
                ...
                if match_vanilla:
                    ...
                    result.append((directory_name, number_vanilla / 40000 ))
                    numbers_gmean_vanilla.append(float(number_vanilla / 40000))
                    print(str(result))
                    break
