...
directory_names = ["cactuBSSN", "lbm", "exchange2", "mcf", "nab", "deepsjeng", "leela","exchange" ,"imagick", "perlbench", "omnetpp", "xalancbmk" , "gcc"]
#directory_names = ["bc" ,"bfs", "sssp" ,"pr", "pr_spmv","cc","cc_sv" ,"tc"]
csv_file_path = './BP_Motiv_spec.csv'
'''
        ...
        with open(txt_file_path_vanilla, 'r') as file_vanilla:
            ...
            for line_vanilla in file_vanilla:
                ...
                if match_tlb_l1_cache_l2_hit:
                    ...
                    #L1 TLB L1 Cache
                    if (total_access_tlb_l1 ==0):
                        result_1.append(float(0.0))
                        result_1.append(float(0.0))
                    else:
                    ...
                    #L2 TLB L1 Cache
                    if (total_access_tlb_l2 ==0):
                        result_3.append(float(0.0))
                        result_3.append(float(0.0))
                    else:
